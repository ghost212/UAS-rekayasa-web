	...
	<div id="footer">
		<ul class="contacts">
			<h3>Contact Us</h3>
			<li><span>Email</span><p>: hawx_212@yahoo.com</p></li>
			<li><span>Address</span><p>: Tugas UAS Rekayasa WEB STMIK EL Rahma </p></li>
		...
		<span class="footnote">&copy; Copyright &copy; 2017. All rights reserved</span>
	</div> <!-- /#footer -->
</body>
</html>